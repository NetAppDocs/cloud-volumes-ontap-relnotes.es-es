...
El parche Cloud Volumes ONTAP 9.17.1 P1 ya está disponible para su implementación y actualización en Azure y Google Cloud. Sin embargo, esta versión no está disponible para su implementación y actualización en AWS. La consola le pedirá que actualice sus sistemas existentes a esta versión de parche.
