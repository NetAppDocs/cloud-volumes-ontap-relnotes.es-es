...
link:https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-gcp-image-verification.html["Más información acerca de la verificación de imágenes de Google Cloud"^].
