...
En implementaciones de nodo único, a partir de Cloud Volumes ONTAP 9.18.1, si seleccionas las variantes de SSD local (LSSD) de las VMs C3, Flash Cache se activa de forma predeterminada. No puedes cambiar entre variantes de VM C3 LSSD en tu implementación de Cloud Volumes ONTAP, incluso si la variante de destino admite Flash Cache.
