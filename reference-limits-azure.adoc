...
NetApp no admite exceder el límite de capacidad del sistema. Si alcanza el límite de capacidad con licencia, la consola de NetApp muestra un mensaje de acción requerida y le impide agregar más discos.
